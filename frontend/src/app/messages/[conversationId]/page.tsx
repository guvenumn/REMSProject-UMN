// Path: /frontend/src/app/messages/[conversationId]/page.tsx
...
// Same mock data as in the messages page
...
export default function ConversationPage() {
  ...
  // If the conversation doesn't exist, redirect to the messages page
  useEffect(() => {
