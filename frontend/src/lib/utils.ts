...
/**
 * Combines multiple class names, handles conditional classes, and merges tailwind classes correctly
 * Uses clsx for handling conditionals and tailwind-merge to handle conflicting tailwind classes
 */
